...
@Application(defaultController = MessageApplication.class)
@Portlet(name="MessagePortlet")
@Bindings(
        {
...
@Assets(
        ...
        scripts = {
                ...
                @Script(id = "services", src = "js/messaging/services.js"),
                @Script(id = "controllers", src = "js/messaging/controllers.js"),
                @Script(id = "messaging", src = "js/messaging/messaging.js")

        },
        stylesheets = {
                @Stylesheet(src = "/org/exoplatform/addons/messaging/portlet/message/assets/css/bootstrap.css",location = AssetLocation.APPLICATION, id = "bootstrap")
        }
)
...
import org.exoplatform.addons.messaging.provider.GateInMetaProvider;
